...
The goal of MIMER is to provide various utility functions to process MIMIC dataset to support various data science projects.
...
#not recommended to use. Education purpose only..                                      
...
devtools::install_github("CAMO-NET-LIV/MIMER", auth_token="<your_personal_access_token>")

or

install.packages("pak")
pak::pak("CAMO-NET-LIV/MIMER")
```
...
library(MIMER)
## basic example code
df <- data.frame(subject_id=c('10016742','10016742','10016742',
